using System;
 ...
 public void OnMoveComplete(){
   ...
   this.entity.combat:Attack(this.target, this.entity.weaponContainer.takeWeapon);
 }
 public void OnStartRunning(){
   this.state = STATE_MOVING;
   this.entity.mover:SetGoal(this.target, null, this.entity.weaponContainer:GetAttackDistance(this.entity.weaponContainer.takeWeapon));
 }
