using System;
 ...
 namespace MainGame{
 public class character :unityexistsentity{
 var CharacterEntity = Class({__includes=UnityExistsEntity, init = public void (self, gameObject){
       UnityExistsEntity.init(self, gameObject);
       this.config = ConfigComponent("heroes", this.name);
